...
const addElement = document.getElementById('btnAdd');
addElement.addEventListener('click', AddRow);

const calculateElement = document.getElementById('btnCalculate');
calculateElement.addEventListener('click', ShowTotal);
...
function ShowTotal() {
    document.getElementById("total").innerHTML = '<span style="font-size:40px;color: blue;background-color: orange">Your checkout total is: ' + totalPrice + '</span>';
}